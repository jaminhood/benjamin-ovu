 ...
 if (isMobile) {
  return (
   <Section cls="bg-gray-950 text-gray-50">
    <Heading cls="items-center" sub="Contact Me" title="Get In Touch" />
    <h4 className="text-base text-center">
     Have A Project In Mind?. Send Me A DM.
    </h4>
    <div className="grid grid-cols-2 mt-8 gap-4">
     <div className="col-span-1 flex justify-center items-center flex-col">
      <Link href="tel:07040354706" target="_blank">
       <BiPhone size={ICON_SIZE_MOBILE} />
      </Link>
     ...
     <div className="col-span-2 flex justify-center items-center flex-col">
      <Link href="mailto:official.benjaminovu@gmail.com" target="_blank">
 ...
 return (
  <Section cls="bg-gray-950 text-gray-50">
   ...
   <div className="grid grid-cols-3 mt-8">
    <div className="col-span-1 flex justify-center items-center flex-col">
     <Link href="tel:07040354706" target="_blank">
      <BiPhone size={ICON_SIZE_DESKTOP} />
     </Link>
