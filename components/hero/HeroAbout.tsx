...
const HeroAbout = () => {
   ...
   <div className="p-4 bg-gray-800 text-gray-50 absolute -bottom-44 rounded-lg w-full shadow-md flex justify-center items-center">
    <div className="grid grid-cols-1 gap-4 w-full">
     {HeroAboutData.map((data) => (
      <HeroAboutCard data={data} key={data.id} />
     ))}
    </div>
   </div>
  )
 ...
 return (
  <div className="p-8 bg-gray-800 text-gray-50 h-28 absolute -bottom-24 rounded-full w-full shadow-md flex justify-center items-center">
